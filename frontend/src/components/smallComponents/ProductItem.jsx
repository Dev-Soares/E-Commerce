...
const ProductItem = ({ productTitle, productPrice, productCategory, productId, productDescription }) => {
    ...
    return (
        ...
        <div onClick={(e) => goToProductPage(e)} className=" h-fit flex flex-col rounded-xl shadow-lg border-product bg-gray-100 w-80 cursor-pointer hover:shadow-xl hover:translate-y-[-3px] transition-transform duration-300 max-h-105 ">
